...
let designers = {
  ...
  'Olivia Siobhán': {
    name: 'iver',
    image: 'iver',
    desc: `Olivia Siobhán is an undergraduate student attending the University of California, Davis, where she is pursuing a degree in Design, Textiles & Clothing and Theatre & Drama. Her work bridges the gap between streetwear and feminine styles while subtly including her life story and topics of mental health. Siobhán is currently the Chief of Marketing for Fashion and Design Society at her school and was previously the Set & Design Manager and Vice President. Within this club, she helps manage the content produced, its promotions and its annual fashion show found in the UC Davis Picnic Day event.`
  },
  'Siuyan Wong': {
    name: 'pomo proportion',
    image: 'pomo',
...
for (let d in designers)
  designerBlock.innerHTML += `
    <div class='designer'>
      <div class='name'>
        <span>${designers[d].name}</span> - ${d}
      </div>
      <div class='inner'>
        <div class='portrait-group'>
          <div class='portrait' style='background-image: url("/media/collections/${designers[d].image}1-min.jpg");background-size: cover;background-position: center;'></div>
          <div class='portrait' style='background-image: url("/media/collections/${designers[d].image}2-min.jpg");background-size: cover;background-position: center;'></div>
        </div>
        <div class='right'>
          <div class='content'>
            ${designers[d].desc}
